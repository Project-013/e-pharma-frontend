      ...
      <div class="row my-3 justify-content-center">
        ...
        <div class="col-md-5 p-3">
          ...
          <p class="text-justify _service_desc">
            ...
            }}</strong> নিশ্চিত করে। যে সেবাটি <strong class="text-primary"> সিলেট শহরের</strong>  সকল অভিজ্ঞ রেজিস্টার্ড নার্স/মিডওয়াইফ দ্বারা পরিচালিত করা হয়। যার ফলে সেবার সর্বোত্তম মান নিশ্চিত হয়।
          </p>

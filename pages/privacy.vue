<template>
  <div class="container text-dark">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to sasthosebok.com, #533, Kakoli Shoping
          Center(4th Floor), Zindabazar, Sylhet-3100.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to sasthosebok.com, accessible from
          <a
            href="https://sasthosebok.com/"
            rel="external nofollow noopener"
            target="_blank"
            >https://sasthosebok.com/</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: info@sasthosebok.com</p>
      </li>
      <li>

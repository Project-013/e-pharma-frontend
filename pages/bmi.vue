          ...
          <div class="card p-0">
            ...
            <div v-if="this.result" class="card-footer text-center">
              ...
              >
                ...
                মেদবহুল
                <p class="small">30-এর বেশি BMI নির্দেশ করে যে আপনি উচ্চ রক্তচাপ, ডায়াবেটিস এবং কার্ডিওভাসকুলার সমস্যাগুলির মতো অতিরিক্ত ওজন সম্পর্কিত রোগগুলির জন্য সম্ভাব্য ঝুঁকিতে রয়েছেন। 30 এর পরে, ঝুঁকিগুলি আরও বেশি। আপনার ডাক্তারের সাথে পরামর্শ করার পর, স্বাভাবিক হারে ফিরে যেতে ওজন কমানোর পরামর্শ দেওয়া হয়।</p>
              </div>
            </div>
          </div>

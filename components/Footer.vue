<template>
  <section class="mb-5 mb-md-0 pt-4">
    <section id="contact" class="footer_wrapper d-none d-md-block pt-5 mt-3">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-4 d-none">
            ...
            <div class="form-group mb-4">
              ...
              <button
                type="submit"
                class="main-btn rounded-2 mt-3 border-white text-white"
              >
                Subscribe
              </button>
            </div>
